...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BK5VutQG.js
var router_BK5VutQG_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Djqv-JOe.css";
var APP_NAME = "AstroForge: Dyson Protocol";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Idle sci-fi foundry. Mine asteroids, raise a Dyson swarm, and collapse the star for quarks."
			},
			{
				name: "theme-color",
				content: "#07090d"
...
var $$splitComponentImporter = () => import("./routes-DSAfoRsb.mjs");
...
//#endregion
export { getRouter, router_BK5VutQG_exports as t };
